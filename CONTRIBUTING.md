...
This outlines how to propose a change to grateful. For a detailed
discussion on contributing to this package, please see the tidyverse
...
- Fork the package and clone onto your computer. If you haven’t done
  ...
  `usethis::create_from_github("Pakillo/grateful", fork = TRUE)`.
...
Code of Conduct](https://pakillo.github.io/grateful/CODE_OF_CONDUCT.md).
