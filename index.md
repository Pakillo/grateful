...
Calling
[`cite_packages()`](https://pakillo.github.io/grateful/reference/cite_packages.md)
...
![](reference/figures/example-output.png)
...
Besides printing a table with package info, it will also save a BibTeX
file with references. By default, the file will be called
`grateful-refs.bib`, but you can change that (see function help).
