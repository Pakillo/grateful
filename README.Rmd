...
**grateful** can be used in one of two ways: (i) to generate a new document listing each package and their citations, or (ii) to build citation keys to incorporate into an existing R Markdown or Quarto document. 
