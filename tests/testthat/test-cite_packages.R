test_that("cite_packages returns correct citekeys", {
  ...
  expect_identical(cite_packages(output = "citekeys", pkgs = c("remotes", "renv")),
                   c("remotes", "renv"))
})
...
test_that("cite_packages returns correct table", {
  ...
  tabla <- cite_packages(output = "table", pkgs = c("remotes", "renv"))
...
test_that("cite_packages returns correct paragraph", {
  ...
  para <- cite_packages(output = "paragraph", pkgs = c("remotes", "renv"))
  ...
  para <- cite_packages(output = "paragraph", pkgs = "Session")
  expect_identical(para,
